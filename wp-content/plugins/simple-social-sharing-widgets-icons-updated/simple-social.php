...
function simple_social($content) {
    ...
    if (!is_feed() && !is_page() && is_single()) {
        ...
        if (get_option('ss_facebookwidget','1')) {
            $simplesocialcontent .= '<div class=simplesocial><iframe src="http://www.facebook.com/plugins/like.php?href='.$simplesocial_enclink.'&layout=standard&show_faces=true&width=350&action=like&colorscheme=light&height=35" scrolling="no" frameborder="0" style="border:1px solid #eee; overflow:hidden; width:200px; height:160px; padding:5px;" allowTransparency="true"></iframe></div>';
        }
        ...
        if (get_option('ss_facebook','1')) {
            $simplesocialcontent .= '<a class=simplesocial onclick="return simplesocial(this,500,400)" title="Compartir en Facebook" style="background:url('.$simplesocial_dir.'facebook.png)" href="http://www.facebook.com/share.php?u='.$simplesocial_enclink.'&t='.$simplesocial_title_4url.'"></a>';
        }
        ...
        if (get_option('ss_email','1')) {
            $simplesocialcontent .= '<a class=simplesocial onclick="return simplesocial(this,435,500)" title="Envíale un mail a tus amigos" style="background:url('.$simplesocial_dir.'email.png)" href="http://www.freetellafriend.com/tell/?heading=Share+This+Article&bg=1&option=email&url='.$simplesocial_enclink.'"></a>';
        }
        ...
        if (get_option('ss_google','1')) {
            $simplesocialcontent .= '<a class=simplesocial onclick="return simplesocial(this,750,500)" 
            title="Compartir en Google" style="background:url('.$simplesocial_dir.'google.png)" href="http://www.google.com/bookmarks/mark?op=add&bkmk='.$simplesocial_enclink.'&title='.$simplesocial_title_4url.'"></a>';
        }
        ...
        if (get_option('ss_rss','1')) {
            $simplesocialcontent .= '<a class=simplesocial title="Suscríbete a nuestro canal de noticas RSS" style="background:url('.$simplesocial_dir.'rss.png)" href="'.get_option('home').'/?feed=rss2"></a>';
        }
