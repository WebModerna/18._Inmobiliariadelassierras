...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		body { background: #<?php echo(get_option($shortname.'_color_bgcolor')); ?>; }
		...
		#sidebar h4.widgettitle { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		#sidebar a { color:#<?php echo(get_option($shortname.'_sidebar_links')); ?>; }
