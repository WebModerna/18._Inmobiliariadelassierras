...
function custom_login_logo()
{
	echo '<style type="text/css">
		...
		h1 a
		{
			background: #fff url("' . get_bloginfo('stylesheet_directory') . '/images/logo.png") center center no-repeat !important;
...
{
	echo 'Desarrollado por <a href="http://www.webmoderna.com.ar" target="_blank">...:: WebModerna | el futuro de la web ::...</a></p>';
};
