      ...
      function geocodeResult(results, status) {
         ...
         if (status == 'OK' && results.length > 0) {         
			...
			var myOptions = {
			   ...
			   mapTypeId: google.maps.MapTypeId.SATELLITE //acá puse la palabra satelite para que accediera modo satélite.
			};
            ...
            '<div id="bodyContent">'+
            '<p><a target="_blank" href="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q='+escape(results[0].geometry.location.b+'&amp;ie=UTF8&amp;view=map">'+results[0].geometry.location.c+'</a>'+
            '</p>'+
            '</div>'+
            '</div>';
            //&amp;sll=29.67226,-94.873971
            /*En lo anterior modifique el código para que google maps me muestre el título del producto y además las coordenadas cartográficas. Pero por las dudas dejaré a acá copiado el código original por las dudas
