<?php 
$listings1 = get_option('elegantestate_listings1');
$listings2 = get_option('elegantestate_listings2');
$listings3 = get_option('elegantestate_listings3');
/*$listings4 = get_option('elegantestate_listings4'); Browse Listings*/?>
<div id="listings">
	<div id="listings-content">
		<h4 class="title"><span><?php esc_html_e('','ElegantEstate'); ?></span></h4>
		
		<div id="listings-options">
		
			<form method="get" action="<?php echo home_url(); ?>" class="clearfix">
				<div class="select">
			...
			<form method="get" action="<?php echo home_url(); ?>" class="clearfix">-->
				<div class="select">
					<select class="option-listing" name="option-listing">
						<option value="" selected="selected">Tipo de Producto</option>
			...
			<!--  Comenté los formulario más arriba para poder hacer la búsqueda mucho más selectiva con todos los parámetros.
			<form method="get" action="<?php echo home_url(); ?>" class="clearfix">
				<div class="select">
					<select class="option-listing" name="option-listing">
